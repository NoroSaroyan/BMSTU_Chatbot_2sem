...
int main() {
    MenuItem items[ITEMS_NUMBER]{MenuItem{"Login", loginFunction}, MenuItem{"Register", registration}, MenuItem{"Catalog", questions}, MenuItem{"How do we store data?", dataStoringGuide}, MenuItem{"Privacy policy", privacyPolicy}};
